          ...
          <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
            ...
            <ul className="text-sm font-mono text-emerald-400">
              {generatedStrings.length > 0 ? (
                ...
                <li className="text-slate-500 italic">No strings generated</li>
              )}
            </ul>
          </div>
          <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
            ...
            <div className="text-sm font-mono text-purple-300">
              {cfgRules.length > 0 ? (
                ...
                <div className="text-slate-500 italic">No CFG generated</div>
              )}
            </div>
          </div>
          <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
            ...
            <div className="text-sm font-mono text-blue-300">
              {reOutput ? (
                ...
                <span className="text-slate-500 italic">No RE generated</span>
              )}
            </div>
          </div>
        </div>
